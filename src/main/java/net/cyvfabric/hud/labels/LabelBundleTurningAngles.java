    ...
    public LabelBundleTurningAngles() {
        this.labels.add(new DraggableHUDElement() {
            ...
            public void extractRenderState(GuiGraphicsExtractor context, ScreenPosition pos) {
                ...
                text(context, "Jump Angle: ", pos.getAbsoluteX() + 1, pos.getAbsoluteY() + 1 + getHeight()*0, color1);
                text(context, ja+"\u00B0", pos.getAbsoluteX() + 1 + font.width("Jump Angle: ")
            ...
            public void renderDummy(GuiGraphicsExtractor context, ScreenPosition pos) {
                ...
                text(context, "Jump Angle: ", pos.getAbsoluteX() + 1, pos.getAbsoluteY() + 1 + getHeight()*0, color1);
                text(context, str+"\u00B0", pos.getAbsoluteX() + 1 + font.width("Jump Angle: ")
                        , pos.getAbsoluteY() + 1, color2);
            }
        });
        ...
        this.labels.add(new DraggableHUDElement() {
            ...
            public void extractRenderState(GuiGraphicsExtractor context, ScreenPosition pos) {
                ...
                text(context, "Second Turn: ", pos.getAbsoluteX() + 1, (int) (pos.getAbsoluteY() + 1), color1);
                text(context, st, pos.getAbsoluteX() + 1 + font.width("Second Turn: ")
            ...
            public void renderDummy(GuiGraphicsExtractor context, ScreenPosition pos) {
                ...
                text(context, "Second Turn: ", pos.getAbsoluteX() + 1, (int) (pos.getAbsoluteY() + 1), color1);
                text(context, str, pos.getAbsoluteX() + 1 + font.width("Second Turn: ")
                        , (int) (pos.getAbsoluteY() + 1), color2);
            }
        });
        ...
        this.labels.add(new DraggableHUDElement() {
            ...
            public void extractRenderState(GuiGraphicsExtractor context, ScreenPosition pos) {
                ...
                text(context, "Preturn: ", pos.getAbsoluteX() + 1, (int) (pos.getAbsoluteY() + 1), color1);
                text(context, pt+"\u00B0", pos.getAbsoluteX() + 1 + font.width("Preturn: ")
                        , (int) (pos.getAbsoluteY() + 1), color2);
            }
            public void renderDummy(GuiGraphicsExtractor context, ScreenPosition pos) {
                int d = CyvClientConfig.getInt("df",5);
                ...
                text(context, "Preturn: ", pos.getAbsoluteX() + 1, (int) (pos.getAbsoluteY() + 1), color1);
                text(context, str+"\u00B0", pos.getAbsoluteX() + 1 + font.width("Preturn: ")
                        , (int) (pos.getAbsoluteY() + 1), color2);
            }
        });
    }
