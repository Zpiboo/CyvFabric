...
public class TogglesprintHUD extends DraggableHUDElement {
    ...
    private void renderText(GuiGraphics context, ScreenPosition pos) {
        ...
        drawString(context, TEXT, pos.getAbsoluteX() + 1 + font.width("["), pos.getAbsoluteY() + 1, color2);
        drawString(context, "]", pos.getAbsoluteX() + 1 + font.width("[" + TEXT), pos.getAbsoluteY() + 1, color1);
    }
}
